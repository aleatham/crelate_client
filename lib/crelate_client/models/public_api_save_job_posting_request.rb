...
module CrelateClient
  ...
  class PublicApiSaveJobPostingRequest
    attr_accessor :city
    ...
    def hash
      [city, company_name, compensation, country_id, country_name, description, external_primay_key, job_code, state, title, url_slug, zip].hash
    end
