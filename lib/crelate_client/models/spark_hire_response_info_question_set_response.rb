...
module CrelateClient
  ...
  class SparkHireResponseInfoQuestionSetResponse
    ...
    def self.swagger_types
      {
        ...
        :'parent_id' => :'String',
        :'name' => :'String',
        :'additional_details' => :'QuestionSetResponse'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AdditionalDetails')
        self.additional_details = attributes[:'AdditionalDetails']
      end
    ...
    def hash
      [external_id, parent_id, name, additional_details].hash
    end
