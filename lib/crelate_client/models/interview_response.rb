...
module CrelateClient
  ...
  class InterviewResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'share_link')
    ...
    def hash
      [type, status, job_post, share_link, created_at, updated_at, scheduled_at, completed_at, assigned_to, uuid, name].hash
    end
