...
module CrelateClient
  ...
  class PublicApiGetJobPostingSearchResult
    attr_accessor :city
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'JobNum')
        self.job_num = attributes[:'JobNum']
      end
    ...
    def hash
      [city, company_name, description, id, job_code, job_num, last_posted_on, state, title, zip, primary_owner_name].hash
    end
