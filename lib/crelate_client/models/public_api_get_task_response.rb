...
module CrelateClient
  ...
  class PublicApiGetTaskResponse
    ...
    def hash
      [created_by_id, created_by_name, created_on, id, modified_by_id, modified_by_name, modified_on, owners, parent_id, parent_name, announced, body, completed, external_primary_key, pinned, _when].hash
    end
