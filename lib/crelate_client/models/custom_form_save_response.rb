...
module CrelateClient
  ...
  class CustomFormSaveResponse
    ...
    def self.swagger_types
      {
        ...
        :'status_code' => :'Integer',
        :'message' => :'String',
        :'usage' => :'CustomFormFormDefinitionUsage',
        :'form_responses' => :'Array<Hash<String, Object>>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'FormResponses')
        if (value = attributes[:'FormResponses']).is_a?(Array)
          self.form_responses = value
        end
      end
    ...
    def valid?
      status_code_validator = EnumAttributeValidator.new('Integer', ["0", "1", "2", "3", "4", "5"])
    ...
    def hash
      [id, status_code, message, usage, form_responses].hash
    end
