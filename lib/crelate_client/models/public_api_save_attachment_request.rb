...
module CrelateClient
  ...
  class PublicApiSaveAttachmentRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IsResume')
        self.is_resume = attributes[:'IsResume']
      end
    ...
    def hash
      [content, document_type, file_name, is_document, is_image, is_resume].hash
    end
